...
public class NewUserActivity extends ActionBarActivity
  ...
  private void SetAvatars() {
	...
	item_one.img_url_ = GetUrlTask.GetJactDomain() + "/sites/default/files/avatar_selection/avatars-blue.jpg";
	avatars_list_.add(item_one);
	AvatarItem item_two = new AvatarItem();
	item_two.id_ = "223";  // green
	item_two.img_url_ = GetUrlTask.GetJactDomain() + "/sites/default/files/avatar_selection/avatars-green.jpg";
	avatars_list_.add(item_two);
	AvatarItem item_three = new AvatarItem();
	item_three.id_ = "224";  // red
	item_three.img_url_ = GetUrlTask.GetJactDomain() + "/sites/default/files/avatar_selection/avatars-red.jpg";
