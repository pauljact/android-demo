...
public class GcmIntentService extends IntentService {
  ...
  protected void onHandleIntent(Intent intent) {
      ...
      if (extras != null && !extras.isEmpty() && !JactActionBarActivity.IS_PRODUCTION) {
      ...
      boolean should_send_notification = true;
      ...
      if (intent_action == null) {
        ...
        if (!JactActionBarActivity.IS_PRODUCTION) {
          Log.e("PHB TEMP", "GcmIntentService::onHandleIntent. Intent Action is REGISTRATION.");
        }
        ...
        if (!JactActionBarActivity.IS_PRODUCTION) {
          Log.e("PHB TEMP", "GcmIntentService::onHandleIntent. Intent Action is RECEIVE.");
        }
      } else if (!JactActionBarActivity.IS_PRODUCTION) {
        Log.e("PHB TEMP", "GcmIntentService::onHandleIntent. Unhandled intent_action: " + intent_action);
      }
      if (should_send_notification && extras != null && !extras.isEmpty()) {  // has effect of unparcelling Bundle
  ...
  private void sendNotification(String msg) {
      ...
      .setContentTitle("Old GCM Notification")
